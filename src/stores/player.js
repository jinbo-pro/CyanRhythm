...
// （控制台报 "MediaElementAudioSource outputs zeroes due to CORS access restrictions"）。
// Howler html5 模式通过 _obtainHtml5Audio 获取 <audio> 元素，
// 在返回前统一设置 crossOrigin='anonymous'，使浏览器发起 CORS 请求。
// Tauri asset 协议已返回 Access-Control-Allow-Origin 头，校验可通过。
const _origObtainHtml5Audio = Howler._obtainHtml5Audio.bind(Howler)
Howler._obtainHtml5Audio = function () {
  const node = _origObtainHtml5Audio()
